...
namespace Registration.Context.Repository.UserRepository
{
    ...
    {
        Task<IdentityResult> CreateUserAsync (string Email,string Password,string Role,string FirstName,string LastName,DateTime BirthDay,bool IsAgree,string? SecondName);
